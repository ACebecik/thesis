...
if __name__ == "__main__":
    ...
    """
        ...
        disp_conf_matrix = ConfusionMatrixDisplay(ansari_conf)
        disp_conf_matrix.plot()
        plt.savefig("conf/ansari_unovis.png")
        plt.clf()

        ansari_loss, ansari_acc, ansari_conf, compensation_segments, compensation_targets, reference_segments =  testClassifier("ansari", ansari_model, X_test=X_test_mit, y_test=y_test_mit, X_test_reference=X_test_reference_mit)
        
        disp_conf_matrix = ConfusionMatrixDisplay(ansari_conf)
        disp_conf_matrix.plot()
        plt.savefig("conf/ansari_mit.png")
        plt.clf()

        ansari_loss, ansari_acc, ansari_conf, compensation_segments, compensation_targets, reference_segments =  testClassifier("ansari", ansari_model, X_test=X_test, y_test=y_test, X_test_reference=X_test_reference)
        
        disp_conf_matrix = ConfusionMatrixDisplay(ansari_conf)
        disp_conf_matrix.plot()
        plt.savefig("conf/ansari_unified.png")
        plt.clf()

        ansari_loss, ansari_acc, ansari_conf, compensation_segments, compensation_targets, reference_segments =  testClassifier("ansari", ansari_model, X_test=X_validation, y_test=y_validation, X_test_reference=X_test_reference_unovis)
        
        disp_conf_matrix = ConfusionMatrixDisplay(ansari_conf)
        disp_conf_matrix.plot()
        plt.savefig("conf/ansari_val.png")
        plt.clf()
    """
 ...
 #  comp_loss, compensated_segments = applyCompensation("fcn-dae", fcn_dae_model, X_test=compensation_segments, y_test=reference_segments)
  #  comp_loss, compensated_segments = applyCompensation("fcn-dae-skip", fcn_dae_skip_model, X_test=X_test_unovis, y_test=X_test_reference_unovis)
    ...
    ansari_loss, ansari_acc, ansari_conf, compensation_segments, compensation_targets, reference_segments =  testClassifier("lstm", lstm_model, X_test=X_test_unovis, y_test=y_test_unovis, X_test_reference=X_test_reference_unovis)
    
    disp_conf_matrix = ConfusionMatrixDisplay(ansari_conf)
    disp_conf_matrix.plot()
    plt.savefig("conf/lstm_unovis.png")
    plt.clf()

    ansari_loss, ansari_acc, ansari_conf, compensation_segments, compensation_targets, reference_segments =  testClassifier("lstm", lstm_model, X_test=X_test_mit, y_test=y_test_mit, X_test_reference=X_test_reference_mit)
    
    disp_conf_matrix = ConfusionMatrixDisplay(ansari_conf)
    disp_conf_matrix.plot()
    plt.savefig("conf/lstm_mit.png")
    plt.clf()

    ansari_loss, ansari_acc, ansari_conf, compensation_segments, compensation_targets, reference_segments =  testClassifier("lstm", lstm_model, X_test=X_test, y_test=y_test, X_test_reference=X_test_reference)
    
    disp_conf_matrix = ConfusionMatrixDisplay(ansari_conf)
    disp_conf_matrix.plot()
    plt.savefig("conf/lstm_unified.png")
    plt.clf()

    ansari_loss, ansari_acc, ansari_conf, compensation_segments, compensation_targets, reference_segments =  testClassifier("lstm", lstm_model, X_test=X_validation, y_test=y_validation, X_test_reference=X_test_reference_unovis)
    
    disp_conf_matrix = ConfusionMatrixDisplay(ansari_conf)
    disp_conf_matrix.plot()
    plt.savefig("conf/lstm_val.png")
    plt.clf()
